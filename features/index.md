...
Latte+ provides full-stack support for Latte templates. The pages below group the
features by area — start with the ones most relevant to how you work.
...
| [Nette integration](./nette-integration.html) | `{link}`, `{control}`, `{form}`, `{snippet}` and layout/extends awareness. |
